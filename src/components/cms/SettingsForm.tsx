...
export function SettingsForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      {/* ── Sticky page header ── */}
      <div className="sticky top-0 z-10 -mx-6 mb-6 flex items-center justify-between bg-neutral-50/90 dark:bg-neutral-950/90 backdrop-blur px-6 py-4 border-b border-black/5 dark:border-white/[0.06]">
        <div>
